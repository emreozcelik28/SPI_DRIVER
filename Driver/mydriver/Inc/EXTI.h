...
typedef struct{
	...
	uint8_t EXTI_LineNumber;          /* EXTI line number for valid GPIO pin @def_groups EXTI_Line_Values  */
	uint8_t TriggerSelection;         /* EXTI trigger selection values  @def_groups EXTI_Trigger_Modes     */
	uint8_t EXTI_Mode;                /* EXTI mode values  @def_groups EXTI_Modes                          */
