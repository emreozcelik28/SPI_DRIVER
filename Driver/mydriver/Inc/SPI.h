...
typedef struct {
	...
	uint32_t Mode;                /* Mode Values for SPI @def_groups Mode_Values            */
	uint32_t CPHA;                /* CPHA Values for SPI @def_groups CPHA_Values            */
	uint32_t CPOL;                /* CPOL Values for SPI @def_groups CPOL_Values            */
	uint32_t BaudRate;            /* Baud Rate Values for SPI @def_groups SPI_BaudRates     */
	uint32_t SSM_Cmd;             /* SSM Values for SPI @def_groups SSM_Values              */
	uint32_t DFF_Format;          /* DFF Values for SPI @def_groups DFF_Values              */
	uint32_t BusConfig;           /* BussConfig Values for SPI @def_groups BusConfig_Values */
	uint32_t FrameFormat;         /* Frame Format Values for SPI @def_groups FF_Values      */
