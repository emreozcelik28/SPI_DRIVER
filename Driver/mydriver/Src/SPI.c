...
/**
  * @brief  SPI_TransmitHelper_16bits stores the user data into the dr register for 16bits format
  *
  * @param  SPI_Handle = User Config Structure
  *
  * @retval Void
...
/**
  * @brief  SPI_TransmitHelper_8bits stores the user data into the dr register for 8bits format
  *
  * @param  SPI_Handle = User Config Structure
  *
  * @retval Void
...
/**
  * @brief  SPI_TransmitHelper_16bits reads the data register and stores into the user variable for 16 bits format
  *
  * @param  SPI_Handle = User Config Structure
  *
  * @retval Void
...
/**
  * @brief  SPI_TransmitHelper_8bits reads the data register and stores into the user variable for 8 bits format
  *
  * @param  SPI_Handle = User Config Structure
  *
  * @retval Void
...
/**
  ...
  * @param  SPI_Handle = User Config Structure
  *
  * @param  pData = Address of to data send
  *
...
/**
  ...
  * @param  SPI_Handle = User Config Structure
  *
  * @param  pData = Address of to store values the values that i get
  *
  * @param  sizeOfData = Length of your data in bytes
  *
  * @retval Void
...
/**
  * @brief  SPI_TransmitData_IT send the data from  external word with interrupt method
  *
  * @param  SPI_Handle = User Config Structure
  *
...
/**
  * @brief  SPI_ReceiveData_IT reads the data from  external word with interrupt method
  *
  * @param  SPI_Handle = User Config Structure
  *
...
void SPI_ReceiveData_IT(SPI_HandleTypeDef_t *SPI_Handle,uint8_t *pBuffer,uint16_t sizeOfData)
{
	...
	SPI_BusStatus_t busStatus = SPI_Handle->busStateRx;

	if(busStatus != SPI_BUS_BUSY_RX)
	{
